...
- **Standard Burn** (`burn-tokens`) — 7-phase full combustion protocol (~2-3k tokens)
- **Lite Burn** (`burn-tokens-lite`) — budget-friendly token waste (~500-800 tokens)
- **Ultra Burn** (`burn-tokens-ultra`) — nuclear devastation mode (~6-10k tokens)
- **Fortune Cookie** (`fortune-cookie`) — useless wisdom generator (~1.5-2.5k tokens)
