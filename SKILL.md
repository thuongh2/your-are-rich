...
- If the user says **"lite"**, **"quick burn"**, or **"budget"** → Execute the protocol in `skills/burn-tokens-lite.md`
- If the user says **"ultra"**, **"maximum"**, **"inferno"**, or **"nuclear"** → Execute the protocol in `skills/burn-tokens-ultra.md`
- If the user says **"fortune"**, **"wisdom"**, or **"cookie"** → Execute the protocol in `skills/fortune-cookie.md`
- **Default** (any other activation) → Execute the protocol in `skills/burn-tokens.md`
